...
//*******************外加485芯片的定义*******************//
#define USART3_EN			P27
//******************************************************//


#if USE_PRINTF_DEBUG
#define USEING_PRINTF 1
#else
#define USEING_PRINTF 0
#endif

/***********************************常用通讯波特率***********************************/
/*11.0592M晶振最高能产生921600波特率*/
...
/*个串口通讯波特率*/
#define UART1_BRT	BRT_1T(BAUD_115200)
#define UART2_BRT	BRT_1T(BAUD_115200)
#define UART3_BRT	BRT_1T(BAUD_9600)
#define UART4_BRT	BRT_1T(BAUD_9600)
...
// void Inverter_ReceiveData_Handle(uint8_t *ReceiveData);
extern char putchar(char str);
