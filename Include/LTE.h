...
#define LTE_POWER_KEY     P41   //4G模块开关脚
#define LTE_RELOAD		  P15	//4G模块重载
#define LTE_RESET         P14   //4G模块复位
#define LTE_LINKA		  P12	//4G模块Link脚
#define LTE_NET_STATE	  P13	//4G模块状态指示
